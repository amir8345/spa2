...
(
 ...
 liked_type AS event_subject , liked_id AS event_id
 FROM likes
...
'comment' as 'event' , user_id as maker_id , commented_type AS event_subject, commented_id AS event_id
...
'user' as event_subject , posted_id as event_id
FROM posts 
WHERE posted_type = 'user'

UNION ALL

SELECT receiver AS user_id , 'suggestion' AS 'event' , user_id AS maker_id , 'book' AS event_subject , book_id AS event_id
FROM suggestions

UNION ALL

SELECT follower_id as user_id , 'accept' as 'event' , following_id as 'maker_id' , 'user' as 'event_subject' , following_id as 'event_id'
FROM follows
